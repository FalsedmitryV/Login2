...
import com.example.login.utils.PhotosUtils;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static String MY_PREF = "LOGIN_PREFERENCES_FILE";
    ...
    private Intent intentGetContacts;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if((fullUserName = loadUserFullNameFromMyPref()) == null)
        {
            ...
            intentGetContacts = new Intent(Intent.ACTION_PICK, ContactsContract.Contacts.CONTENT_URI);
            PackageManager packageManager = this.getPackageManager();

          /*  if((packageManager.resolveActivity(intentGetContacts, packageManager.MATCH_DEFAULT_ONLY)) == null)
            {
            ...
            if(canTakePhoto)
            {
                Uri uri = FileProvider.getUriForFile(this, "com.example.login2.fileprovider", selfPhotoFile);
    ...
    private File getPhotoFile(String fileName)
    {
        ...
        //TODO: insert chect that file exists, in this case  dont create new file
    ...
    public void onClick(View view)
    {
        if (view.getId() == buttonSendInfoToContact.getId())
        {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, "I have get up at 5:00");
        ...
        {
            startActivityForResult(intentGetContacts, REQUEST_CONTACT);
        }
